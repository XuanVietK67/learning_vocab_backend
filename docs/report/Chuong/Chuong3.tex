...
Language Model --- LLM). LLM là mạng nơ-ron kiến trúc \textit{Transformer}
\cite{vaswani2017attention} được huấn luyện trên khối dữ liệu văn bản khổng
lồ để dự đoán token kế tiếp, nhờ đó có khả năng sinh văn bản mạch lạc, dịch
và đánh giá ngôn ngữ theo chỉ dẫn (prompt). Hệ thống sử dụng hai họ mô hình
mở: \textbf{Gemma} của Google DeepMind \cite{gemma2025technical} cho làm giàu
dữ liệu và chấm điểm câu, và \textbf{Llama~3} của Meta
\cite{grattafiori2024llama3} cho hội thoại luyện nói theo lượt. Trong nghiệp
vụ, LLM được giao vai trò có kiểm soát: sinh nghĩa, ví dụ, bản dịch theo định
dạng yêu cầu, chấm điểm câu theo \textit{rubric}, hoặc đóng vai đối thoại
trong một kịch bản cho trước. Kết quả do AI sinh ra đối với kho hệ thống luôn
phải qua bước \textit{duyệt} của quản trị viên trước khi xuất bản, nhằm kiểm
soát chất lượng và hạn chế lỗi "ảo giác" (hallucination) của mô hình.

\subsection{Học ngôn ngữ giao tiếp và luyện nói nhập vai}
\label{subsec:clt-theory}

Chức năng phòng luyện nói được đặt nền trên \textbf{đường hướng dạy ngôn ngữ
giao tiếp} (Communicative Language Teaching --- CLT) và \textbf{dạy ngôn ngữ
theo nhiệm vụ} (Task-Based Language Teaching --- TBLT)
\cite{richards2014approaches, ellis2003task}. Quan điểm chung của hai đường
hướng này là: năng lực ngôn ngữ được hình thành tốt nhất thông qua việc
\textit{sử dụng} ngôn ngữ để hoàn thành một nhiệm vụ giao tiếp có mục đích,
thay vì chỉ ghi nhớ từ và quy tắc rời rạc. \textit{Nhập vai} (role-play) là
một kỹ thuật tiêu biểu của CLT: người học đảm nhận một vai trong một tình
huống mô phỏng (gọi món tại nhà hàng, phỏng vấn xin việc\ldots) và phải vận
dụng vốn từ, mẫu câu phù hợp để đạt mục tiêu hội thoại.

Một hạn chế cố hữu của nhập vai trong lớp học truyền thống là cần một bạn
luyện tập (interlocutor) luôn sẵn sàng và đủ kiên nhẫn. Mô hình ngôn ngữ lớn
khắc phục được hạn chế này: nó có thể đóng vai đối thoại ở mọi thời điểm,
điều chỉnh độ khó ngôn ngữ theo trình độ CEFR của người học
(mục~\ref{subsec:cefr-theory}) và đưa ra phản hồi chỉnh lỗi mang tính xây dựng. Đây
là cơ sở lý thuyết cho thiết kế: mỗi kịch bản mô tả một nhiệm vụ giao tiếp,
hệ thống dẫn dắt người học qua nhiều lượt nói và tổng kết bằng một báo cáo
phản hồi định hướng luyện tập tiếp.
...
\begin{table}[h]
  ...
  \begin{tabular}{|p{3.0cm}|p{5.0cm}|p{6.4cm}|}
    ...
    \hline
    Trí tuệ nhân tạo & Gemma~3 (Google AI Studio), Groq (Llama~3.3), Edge TTS, vi dịch vụ chấm phát âm & Sinh nội dung, hội thoại luyện nói, sinh âm thanh, chấm điểm luyện tập. \\
    \hline
...
dùng lại giữa kiểm tra phía máy khách và Server Action. Một quyết định đáng
chú ý là các biểu đồ trực quan hoá tiến độ (chuỗi ngày học, biểu đồ hoạt động
dạng heatmap) được \textit{dựng thủ công} bằng CSS/SVG thay vì nhúng một thư
viện biểu đồ, nhằm giữ kích thước gói tải (bundle) nhỏ và toàn quyền kiểm soát
bố cục theo hệ thống thiết kế. Bảng~\ref{tab:frontend-libs} liệt kê các thư
viện frontend chính.
