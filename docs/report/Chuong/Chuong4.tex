...
mục~\ref{sec:kiem-thu} trình bày chiến lược kiểm thử và
...
tự giới hạn tần suất và suy giảm có kiểm soát. Tất cả được củng cố bằng các
chỉ số tiến độ tự động và một chiến lược kiểm thử dựa trên việc tách logic
thành các hàm thuần. Những kết quả hiện thực hoá này là cơ sở để chương tiếp
theo đánh giá hệ thống và rút ra kết luận.
