...
(Chương~\ref{chuong:hien-thuc-hoa}). Phần này trình bày \textit{thiết kế}
giao diện: hệ thống thiết kế (design system) làm nền cho diện mạo nhất quán,
bản đồ điều hướng, phác thảo và ảnh chụp các màn hình chính, cùng ánh xạ giữa
màn hình và API.

\subsection{Hệ thống thiết kế}
\label{subsec:design-system}

Giao diện được dựng trên một \textbf{hệ thống thiết kế} thống nhất thay vì tạo
kiểu rời rạc từng trang. Nền tảng là bộ \textit{biến thiết kế} (design token)
khai báo bằng biến CSS theo không gian màu \textbf{OKLCH}~\cite{w3ccsscolor4}
--- không gian màu đồng đều về cảm nhận, thuận lợi cho việc dựng các thang màu
nhất quán. Hệ thống định nghĩa song song một bảng màu \textit{sáng} và một bảng
màu \textit{tối}, nên đã sẵn sàng cho chế độ tối (theme-ready); một thang
\textit{bo góc} (radius) suy ra theo bội số từ một giá trị gốc giúp độ bo của
mọi thành phần đồng bộ. Bộ thành phần dùng \textbf{shadcn/ui}~\cite{shadcnui2024}
dựng trên các primitive khả truy cập của \textbf{Base UI}~\cite{baseui2024},
tạo kiểu bằng \textbf{Tailwind CSS v4}~\cite{tailwind2024}.
...
Để minh hoạ kết quả hiện thực hoá, các hình tiếp theo là ảnh chụp một số màn
hình chính của ứng dụng đã hoàn thiện, trải đều cả khu vực người học và khu vực
quản trị. Hình~\ref{fig:ui-dashboard} là trang chủ ("Trophy Room") mang nhận
diện Sprout; Hình~\ref{fig:ui-explore} là màn hình khám phá từ vựng và bộ thẻ;
Hình~\ref{fig:ui-word} là chi tiết một từ. Hình~\ref{fig:ui-practice-write} và
Hình~\ref{fig:ui-practice-speak} là hai chế độ luyện tập chủ động (viết câu và
luyện phát âm); Hình~\ref{fig:ui-speaking-room} là phòng luyện nói với hội thoại
theo lượt. Hình~\ref{fig:ui-admin-vocab} và Hình~\ref{fig:ui-admin-review} là
trình soạn từ vựng và hàng đợi duyệt nội dung do AI sinh trong khu vực quản trị.

\figph{ui-dashboard.png}{0.85}{Màn hình trang chủ (Trophy Room) của người học}{fig:ui-dashboard}

\figph{ui-explore.png}{0.85}{Màn hình khám phá từ vựng và bộ thẻ}{fig:ui-explore}

\figph{ui-word-detail.png}{0.85}{Màn hình chi tiết một từ vựng}{fig:ui-word}

\figph{ui-practice-write.png}{0.85}{Màn hình luyện viết câu có chấm điểm}{fig:ui-practice-write}

\figph{ui-practice-speak.png}{0.85}{Màn hình luyện phát âm}{fig:ui-practice-speak}

\figph{ui-speaking-room.png}{0.85}{Màn hình phòng luyện nói: hội thoại theo lượt với AI}{fig:ui-speaking-room}

\figph{ui-admin-vocab.png}{0.85}{Trình soạn từ vựng trong khu vực quản trị}{fig:ui-admin-vocab}

\figph{ui-admin-review.png}{0.85}{Hàng đợi duyệt nội dung do AI sinh}{fig:ui-admin-review}
