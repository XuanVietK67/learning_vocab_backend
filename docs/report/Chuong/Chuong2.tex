...
Như đã nêu ở phạm vi đề tài (mục~\ref{sec:muc-tieu}), trọng tâm của báo cáo
là hệ thống phía máy chủ; giao diện người dùng được xem là bên tiêu thụ API.
Tuy vậy, để làm rõ ngữ cảnh sử dụng, phần này phác thảo các màn hình chính
mà API được thiết kế để phục vụ, cùng bản đồ điều hướng và ánh xạ màn hình
--- API.
