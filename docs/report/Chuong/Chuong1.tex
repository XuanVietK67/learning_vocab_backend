...
Đề tài tập trung vào việc thiết kế và hiện thực hóa \textbf{hệ thống phía
máy chủ (backend)} cùng các API phục vụ toàn bộ nghiệp vụ nêu trên; phần
giao diện người dùng (ứng dụng khách) được xem là bên tiêu thụ API và nằm
ngoài trọng tâm trình bày của báo cáo. Các chương tiếp theo sẽ lần lượt
