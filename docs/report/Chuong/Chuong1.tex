...
Tuy nhiên, ghi nhớ từ vựng lâu dài là một thách thức: theo \textit{đường
cong lãng quên} (forgetting curve) của Ebbinghaus, thông tin mới nhanh chóng
bị quên nếu không ôn tập có hệ thống \cite{ebbinghaus1913memory}, trong khi
\textit{ôn tập ngắt quãng} (spaced repetition) cải thiện đáng kể ghi nhớ dài
hạn so với học dồn \cite{cepeda2006distributed} (chi tiết ở
mục~\ref{sec:co-so-ly-thuyet}). Đây là cơ sở khoa học cho các thuật toán lập
lịch ôn tập trong nhiều phần mềm học tập hiện đại.
...
\begin{table}[h]
  ...
  \begin{tabular}{|p{4.1cm}|p{2.0cm}|p{1.7cm}|p{1.9cm}|p{2.3cm}|}
    ...
    \hline
    Luyện nói hội thoại theo kịch bản & Hạn chế & Không  & Không      & Có \\
    \hline
...
riêng nhưng chưa hệ thống nào đồng thời đáp ứng tốt cả năm yếu tố: kho từ
vựng vừa biên tập sẵn vừa cho phép cá nhân hóa, cơ chế ôn tập ngắt quãng
mạnh, hỗ trợ sinh nội dung tự động bằng AI, tích hợp luyện viết câu cùng
luyện phát âm có chấm điểm, và luyện nói hội thoại nhập vai theo kịch bản có
phản hồi. Đặc biệt, hình thức luyện nói chủ động --- người học hội thoại theo
lượt với một bạn luyện tập ảo và được sửa lỗi tức thì --- gần như vắng bóng ở
các hệ thống học từ vựng phổ biến. Đây chính là khoảng trống mà đề tài hướng
tới.
...
\begin{itemize}
  ...
  \item \textbf{Quản trị viên (admin):} người biên tập và quản lý kho từ
        ...
        học), quản lý chủ đề và bộ thẻ mẫu, đồng thời biên soạn và xuất bản
        các kịch bản luyện nói.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Luyện tập chủ động có phản hồi:} luyện đặt câu với từ vựng,
        luyện phát âm và luyện nói hội thoại nhập vai theo kịch bản, đều có
        cơ chế chấm điểm hoặc sửa lỗi để người học nhận phản hồi.
...
chấm điểm (viết câu, phát âm và luyện nói hội thoại theo kịch bản), qua đó
giúp người học ghi nhớ và vận dụng từ vựng hiệu quả hơn.
...
\begin{enumerate}
  ...
  \item Xây dựng các phân hệ \textbf{luyện viết câu}, \textbf{luyện phát
        âm} và \textbf{luyện nói theo kịch bản} (phòng luyện nói) có cơ chế
        chấm điểm, sửa lỗi và phản hồi.
